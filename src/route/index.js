...
router.get('/template-1', function (req, res) {
  ...
  res.render('template-1', {
    ...
    hero: {
      title: 'Pricing',
      text: "Quickly build an effective pricing table $shy; for your potential customers with this Bootstrap example. It's built with default Bootstrap components and utilities with little customization.",
    },
    plans: [
      {
        name: 'Free',
